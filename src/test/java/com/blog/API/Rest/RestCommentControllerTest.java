...
class RestCommentControllerTest {
    ...
    class CreateComment {
        ...
        void createComment_Failure_PostNotFound() {
            ...
            EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> commentController.createComment(createDTO));
    ...
    class UpdateComment {
        ...
        void updateComment_Success() {
            ...
            ResponseEntity<SuccessResponse<ResponseCommentDTO>> response = commentController.updateComment(1, updateDTO);
            assertEquals(HttpStatus.OK, response.getStatusCode());
            assertNotNull(response.getBody());
        ...
        void updateComment_Failure_CommentNotFound() {
            ...
            EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> commentController.updateComment(99, updateDTO));
