...
class RestAuthenticationControllerTest {
    ...
    class Refresh {
        ...
        void refresh_Failure_ExpiredToken() {
            ...
            doThrow(new AuthenticationException("Refresh token has expired"))
    ...
    class Logout {
        ...
        void logout_Success() {
            ...
            ResponseEntity<SuccessResponse<Void>> response =
                authController.logout("Bearer access.token", new RefreshRequestDTO("refresh.token"));
        ...
        void logout_NoRefreshToken() {
            ...
            ResponseEntity<SuccessResponse<Void>> response =
                authController.logout("Bearer access.token", null);
    ...
    class InspectToken {
        ...
        void inspectToken_Success() {
            ...
            ResponseEntity<SuccessResponse<Map<String, Object>>> response =
                authController.inspectToken("Bearer valid.token");
        ...
        void inspectToken_Failure_NoBearerPrefix() {
            ResponseEntity<SuccessResponse<Map<String, Object>>> response =
                authController.inspectToken("BadHeader");
        ...
        void inspectToken_Failure_NullHeader() {
            ResponseEntity<SuccessResponse<Map<String, Object>>> response =
                authController.inspectToken(null);
