...
class TagServiceTest {
    ...
    void setPostTags_Failure_PostNotFound() {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> tagService.setPostTags(1, tags));
    ...
    void addTagsToPost_Failure_PostNotFound() {
        when(postRepository.findById(1)).thenReturn(Optional.empty());
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> tagService.addTagsToPost(1, tags));
        assertTrue(exception.getMessage().contains("Post not found"));
        verify(repository, never()).save(any());
    }
    @Test
    ...
    void removeTagsFromPost_Failure_PostNotFound() {
        when(postRepository.findById(1)).thenReturn(Optional.empty());
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> tagService.removeTagsFromPost(1, tags));
        assertTrue(exception.getMessage().contains("Post not found"));
    }
    @Test
    ...
    void deleteByPostId_Failure_TagsNotFound() {
        when(repository.findByPostId(1)).thenReturn(Optional.empty());
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> tagService.deleteByPostId(1));
