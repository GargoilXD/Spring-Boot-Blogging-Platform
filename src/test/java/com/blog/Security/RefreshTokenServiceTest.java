...
/**
 * Unit tests for RefreshTokenService — the in-memory refresh token store.
 *
 * Tests validate O(1) store/evict behavior and TTL-aware validation.
 */
class RefreshTokenServiceTest {
    ...
    void expiredToken_IsNotValid() {
        ...
        // TTL of 0ms means Instant.now() + 0 = Instant.now(), which is already past
