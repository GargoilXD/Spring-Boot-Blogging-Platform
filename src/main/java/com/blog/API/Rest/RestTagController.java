...
public class RestTagController {
    ...
    public ResponseEntity<SuccessResponse<Void>> setPostTags(
            ...
            @PathVariable
            Integer postId,
            @Valid @RequestBody TagDTO tags
    ) {
        tagService.setPostTags(postId, tags.tags());
    ...
    public ResponseEntity<SuccessResponse<Void>> addTagsToPost(
        ...
        tagService.addTagsToPost(postId, tags.tags());
    ...
    public ResponseEntity<SuccessResponse<Void>> removeTagsFromPost(
        ...
        tagService.removeTagsFromPost(postId, tags.tags());
